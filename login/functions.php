...
function upload()
{
    ...
    $ambilextensi = strtolower(end($extensigambar));

    if (!in_array($ambilextensi, $extensigambarvalid)) {
        echo "<script>alert('Yang anda diupload bukan gambar')</script>";
        return false;
    }
...
function ubah($data)
{
    ...
    //4 artinya tidak ada file yang diupload
